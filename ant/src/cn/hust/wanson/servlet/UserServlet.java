...
import cn.hust.wanson.serviceImpl.UserServiceImpl;
...
public class UserServlet extends BaseServlet {
	...
	private Map<String,String> validateLogin(User formUser, HttpSession session) throws SQLException {
		...
		if (user==null) {
			...
			boolean userIsExsit = userService.findUserIsExsit(formUser.getLoginname());
			
			  if (userIsExsit) {
				errors.put("loginname", "登录密码错误");
			}
			  else {
				errors.put("loginname", "账号为空");
			}
		}
		return errors;
	}
	...
	public String updatePassword(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			userService.updatePassword(user.getUid(), formUser.getNewpass(), user.getLoginpass());
			req.setAttribute("msg", "修改密码成功");
			req.setAttribute("code", "success");
			return "f:/jsps/msg.jsp";
		} catch (cn.hust.wanson.exception.UserException e) {
